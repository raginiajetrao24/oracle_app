...
class UpdateTreeScreen extends StatefulWidget {
  ...
  const UpdateTreeScreen({super.key, required this.tree});
...
class _UpdateTreeScreenState extends State<UpdateTreeScreen> {
  ...
  void _onSubmit() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Organization tree updated successfully'),
  ...
  String get _displayStructure {
    if (widget.tree.structure == 'PER_ORG_TREE_STRUCTI') {
      return 'HCM Organization Hierarchy Tree Structure';
    }
    return widget.tree.structure;
  }
    ...
    switch (_currentStep) {
      case 0:
        return _Step1Definition(
          ...
          treeCode: widget.tree.code,
          treeStructure: _displayStructure,
      ...
      case 1:
        return _Step2Labels(
          ...
          treeCode: widget.tree.code,
          treeDescription: _descriptionController.text,
          treeStructure: _displayStructure,
...
class _Step1Definition extends StatelessWidget {
  ...
  final TextEditingController nameController, descController;
  final String treeCode, treeStructure, iconImage;
